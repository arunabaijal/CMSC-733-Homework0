...
from Network.Network import CIFAR10Model, ResNet, Dense_net
...
def TrainOperation(ImgPH, LabelPH, DirNamesTrain, TrainLabels, NumTrainSamples, ImageSize,
    ...
    prLogits, prSoftMax = CIFAR10Model(ImgPH, ImageSize, MiniBatchSize, True)
    ...
    with tf.Session() as sess:
        ...
        for Epochs in tqdm(range(StartEpoch, NumEpochs)):
            ...
            if not os.path.exists('Graphs/train/'):
                os.makedirs('Graphs/train/')
            plt.savefig('Graphs/train/accuracyEpochs' + str(Epochs) + '.png')
            plt.subplot(2, 1, 2)
            plt.xlim(0, 60)
            plt.xlabel('Epoch')
            plt.ylabel('Loss')
...
def main():
    ...
    Parser.add_argument('--BasePath', default='/home/aruna/abaijal_hw0/Phase2/CIFAR10', help='Base path of images, Default:/media/nitin/Research/Homing/SpectralCompression/CIFAR10')
    ...
    # LabelsPathPred = './TxtFiles/PredTrainOut.txt'
